...
var PushNotification = /** @class */ (function () {
	function PushNotification() {
		...
		this.configure = function (config) {
			...
			_this.config = tslib_1.__assign(
				tslib_1.__assign({}, _this.config),
				config
			);
		...
		this.getPluggable = function (providerName) {
			var _a;
			var pluggable =
				(_a = _this.pluggables.find(function (pluggable) {
		...
		this.enable = function () {
			...
			var _a = _this.nativeEvent,
				BACKGROUND_MESSAGE_RECEIVED = _a.BACKGROUND_MESSAGE_RECEIVED,
				FOREGROUND_MESSAGE_RECEIVED = _a.FOREGROUND_MESSAGE_RECEIVED,
				LAUNCH_NOTIFICATION_OPENED = _a.LAUNCH_NOTIFICATION_OPENED,
				NOTIFICATION_OPENED = _a.NOTIFICATION_OPENED,
				TOKEN_RECEIVED = _a.TOKEN_RECEIVED;
			if (_this.nativeHeadlessTaskKey) {
				...
				// library listeners
				react_native_1.AppRegistry.registerHeadlessTask(
					_this.nativeHeadlessTaskKey,
					function () {
								...
								return tslib_1.__generator(this, function (_a) {
									switch (_a.label) {
										case 0:
											...
											return [
												4 /*yield*/,
												common_1.notifyEventListenersAndAwaitHandlers(
													0 /* BACKGROUND_MESSAGE_RECEIVED */,
													utils_1.normalizeNativeMessage(message)
												),
											];
										case 1:
											// keep headless task running until handlers have completed their work
							...
							return tslib_1.__generator(this, function (_c) {
								switch (_c.label) {
										...
										return [
											...
											Promise.race([
												...
												new Promise(function (_, reject) {
													setTimeout(function () {
														return reject(
															'onNotificationReceivedInBackground handlers should complete their work within ' +
																BACKGROUND_TASK_TIMEOUT +
																' seconds, but they did not.'
														);
									...
									case 3:
										...
										(_b = (_a = this.nativeModule).completeNotification) ===
											null || _b === void 0
											? void 0
											: _b.call(_a, message.completionHandlerId);
										return [7 /*endfinally*/];
									case 4:
										return [2 /*return*/];
								}
			...
			_this.nativeEventEmitter.addListener(
				...
				function (message) {
					common_1.notifyEventListeners(
						1 /* FOREGROUND_MESSAGE_RECEIVED */,
						utils_1.normalizeNativeMessage(message)
					);
				}
			);
			var launchNotificationOpenedListener = LAUNCH_NOTIFICATION_OPENED
				? _this.nativeEventEmitter.addListener(
						...
						function (message) {
							common_1.notifyEventListeners(
								2 /* LAUNCH_NOTIFICATION_OPENED */,
								utils_1.normalizeNativeMessage(message)
							);
							// once we are done with it we can remove the listener
							launchNotificationOpenedListener === null ||
							launchNotificationOpenedListener === void 0
								? void 0
		...
		this.identifyUser = function (userId, userInfo) {
			...
			return Promise.all(
				_this.pluggables.map(function (pluggable) {
					return tslib_1.__awaiter(_this, void 0, void 0, function () {
						var err_2;
						return tslib_1.__generator(this, function (_a) {
							switch (_a.label) {
				...
				return tslib_1.__generator(this, function (_d) {
					switch (_d.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								(_c = (_b = this.nativeModule).getLaunchNotification) ===
									null || _c === void 0
									? void 0
									: _c.call(_b),
							];
		...
		this.getBadgeCount = function () {
			return tslib_1.__awaiter(_this, void 0, void 0, function () {
				...
				return tslib_1.__generator(this, function (_c) {
					...
					return [
						2 /*return*/,
						(_b = (_a = this.nativeModule).getBadgeCount) === null ||
						_b === void 0
							? void 0
							: _b.call(_a),
					];
		...
		this.setBadgeCount = function (count) {
			var _a, _b;
			_this.assertIsEnabled();
			return (_b = (_a = _this.nativeModule).setBadgeCount) === null ||
				_b === void 0
				? void 0
				: _b.call(_a, count);
		};
				...
				return tslib_1.__generator(this, function (_d) {
					switch (_d.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								(_c = (_b = this.nativeModule).getPermissionStatus) === null ||
								_c === void 0
									? void 0
									: _c.call(_b),
							];
		...
		this.requestPermissions = function (permissions) {
			...
			return tslib_1.__awaiter(_this, void 0, void 0, function () {
				...
				return tslib_1.__generator(this, function (_c) {
					...
					return [
						2 /*return*/,
						(_b = (_a = this.nativeModule).requestPermissions) === null ||
						_b === void 0
							? void 0
							: _b.call(_a, permissions),
					];
				});
			});
		};
		...
		this.onNotificationReceivedInBackground = function (handler) {
			_this.assertIsEnabled();
			return common_1.addEventListener(
				0 /* BACKGROUND_MESSAGE_RECEIVED */,
				handler
			);
		};
			...
			return tslib_1.__awaiter(_this, void 0, void 0, function () {
				...
				return tslib_1.__generator(this, function (_a) {
					return [
						2 /*return*/,
						Promise.all(
							this.pluggables.map(function (pluggable) {
								return tslib_1.__awaiter(_this, void 0, void 0, function () {
									var err_3;
									return tslib_1.__generator(this, function (_a) {
										switch (_a.label) {
											case 0:
												...
												return [
													4 /*yield*/,
													pluggable.registerDevice(this.token),
												];
											case 1:
												_a.sent();
												return [3 /*break*/, 3];
		...
		try {
			...
			var _a = this.nativeModule.getConstants(),
				NativeEvent = _a.NativeEvent,
				NativeHeadlessTaskKey = _a.NativeHeadlessTaskKey;
			this.nativeEvent = NativeEvent;
			this.nativeHeadlessTaskKey = NativeHeadlessTaskKey;
			this.nativeEventEmitter = new react_native_1.NativeEventEmitter(
				rtn_push_notification_1.AmplifyRTNPushNotification
			);
		} catch (err) {
