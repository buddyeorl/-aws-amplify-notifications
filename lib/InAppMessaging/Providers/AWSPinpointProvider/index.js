...
var AWSPinpointProvider = /** @class */ (function (_super) {
	...
	function AWSPinpointProvider() {
		...
		_this.configure = function (config) {
			...
			if (!_this.configured) {
				_this.sessionTracker = new SessionTracker_1.default(
					_this.sessionStateChangeHandler
				);
				...
				common_1.addEventListener(
					...
					function (message) {
						_this.recordMessageEvent(
							message,
							types_2.AWSPinpointMessageEvent.MESSAGE_DISPLAYED
						);
					}
				);
				common_1.addEventListener(
					...
					function (message) {
						_this.recordMessageEvent(
							message,
							types_2.AWSPinpointMessageEvent.MESSAGE_DISMISSED
						);
					}
				);
				common_1.addEventListener(
					...
					function (message) {
						_this.recordMessageEvent(
							message,
							types_2.AWSPinpointMessageEvent.MESSAGE_ACTION_TAKEN
						);
					}
				);
			}
							...
							return [
								...
								this.normalizeMessages(
									messages.reduce(function (acc, message) {
										var messageQualifies =
											utils_1.matchesEventType(message, event) &&
		...
		_this.setDailyCount = function (count) {
			...
			try {
				...
				_this.logger.error(
					'Failed to save daily message count to storage',
					err
				);
			}
		};
		...
		_this.setTotalCount = function (messageId, count) {
			var _a;
			var updatedMap = tslib_1.__assign(
				tslib_1.__assign({}, _this.getTotalCountMap()),
				((_a = {}), (_a[messageId] = count), _a)
			);
		...
		_this.incrementCounts = function (messageId) {
			return tslib_1.__awaiter(_this, void 0, void 0, function () {
				...
				return tslib_1.__generator(this, function (_b) {
					(_a = this.getMessageCounts(messageId)),
						(sessionCount = _a.sessionCount),
						(dailyCount = _a.dailyCount),
				...
				return tslib_1.__generator(this, function (_a) {
					switch (_a.label) {
						...
						case 2:
							...
							if (
								!(event === types_2.AWSPinpointMessageEvent.MESSAGE_DISPLAYED)
							)
								return [3 /*break*/, 4];
