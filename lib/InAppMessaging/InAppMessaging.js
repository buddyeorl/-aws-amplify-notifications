	...
	function InAppMessaging() {
		...
		this.configure = function (_a) {
			...
			var _b = _a.listenForAnalyticsEvents,
				...
				config = tslib_1.__rest(_a, ['listenForAnalyticsEvents']);
						...
						case 1:
							...
							if (flattenedMessages.length) {
								common_1.notifyEventListeners(
									types_1.InAppMessageInteractionEvent.MESSAGE_RECEIVED,
				...
				return tslib_1.__generator(this, function (_a) {
					switch (_a.label) {
						...
						case 3:
							err_4 = _a.sent();
							logger.error(
								'Failed to retrieve in-app messages from storage',
								err_4
							);
							return [3 /*break*/, 4];
						case 4:
				...
				return tslib_1.__generator(this, function (_a) {
					switch (_a.label) {
						...
						case 3:
							err_6 = _a.sent();
							logger.error(
								'Failed to remove in-app messages from storage',
								err_6
							);
							return [3 /*break*/, 4];
						case 4:
		...
		this.defaultConflictHandler = function (messages) {
			...
			var sorted = messages.sort(function (a, b) {
				var _a, _b;
				var endDateA =
					(_a = a.metadata) === null || _a === void 0 ? void 0 : _a.endDate;
				var endDateB =
					(_b = b.metadata) === null || _b === void 0 ? void 0 : _b.endDate;
