...
export declare type NotificationsSubCategory = Extract<
...
export declare type InAppMessageLayout =
	| 'BOTTOM_BANNER'
	| 'CAROUSEL'
	| 'FULL_SCREEN'
	| 'MIDDLE_BANNER'
...
export declare type OnMessageInteractionEventHandler = (
	message: InAppMessage
) => any;
...
export declare type InAppMessageConflictHandler = (
	messages: InAppMessage[]
) => InAppMessage;
export {};
