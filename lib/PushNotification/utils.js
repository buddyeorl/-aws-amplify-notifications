...
exports.normalizeNativePermissionStatus = function (nativeStatus) {
	switch (nativeStatus) {
		...
		case 'ShouldExplainThenRequest':
			return types_1.PushNotificationPermissionStatus
...
exports.normalizeNativeMessage = function (nativeMessage) {
	var normalized;
	if (
		nativeMessage === null || nativeMessage === void 0
			? void 0
			: nativeMessage.aps
	) {
	...
	return tslib_1.__assign(
		tslib_1.__assign(
			tslib_1.__assign(
				tslib_1.__assign(
					tslib_1.__assign(
						tslib_1.__assign({}, body && { body: body }),
		...
		!lodash_1.isEmpty(data) && { data: data }
	);
};
var normalizeApnsMessage = function (apnsMessage) {
	var _a, _b;
	var aps = apnsMessage.aps,
		_c = apnsMessage.data,
		data = _c === void 0 ? {} : _c;
	var _d = (_a = aps.alert) !== null && _a !== void 0 ? _a : {},
		body = _d.body,
		title = _d.title;
	var action =
		(_b = getApnsAction(data.pinpoint)) !== null && _b !== void 0 ? _b : {};
...
var normalizeFcmMessage = function (fcmMessage) {
	var _a;
	var body = fcmMessage.body,
		imageUrl = fcmMessage.imageUrl,
		data = fcmMessage.rawData,
		title = fcmMessage.title;
	var action =
		(_a = getFcmAction(fcmMessage.action)) !== null && _a !== void 0 ? _a : {};
...
var getApnsOptions = function (_a) {
	var aps = _a.aps;
	var _b;
	var subtitle = ((_b = aps.alert) !== null && _b !== void 0 ? _b : {})
		.subtitle;
	var apnsOptions = tslib_1.__assign({}, subtitle && { subtitle: subtitle });
	return tslib_1.__assign(
		{},
		!lodash_1.isEmpty(apnsOptions) && { apnsOptions: apnsOptions }
	);
};
var getFcmOptions = function (_a) {
	...
	var fcmOptions = tslib_1.__assign(
		tslib_1.__assign(
			tslib_1.__assign(
				tslib_1.__assign({}, channelId && { channelId: channelId }),
	...
	return tslib_1.__assign(
		{},
		!lodash_1.isEmpty(fcmOptions) && { fcmOptions: fcmOptions }
	);
};
