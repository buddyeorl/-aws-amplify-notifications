...
var AWSPinpointProviderCommon = /** @class */ (function () {
	function AWSPinpointProviderCommon(logger) {
							...
							input = {
								...
								EventsRequest: {
									BatchItem:
										...
										(_c[endpointId] = {
											Endpoint: {},
											Events: ((_d = {}), (_d[uuid_1.v4()] = event), _d),
										}),
										_c),
								},
							};
					...
					switch (_f.label) {
						...
						case 1:
							...
							credentialsUpdated =
								...
								Object.keys(credentials).some(function (key) {
							...
							(_a = this.config),
								...
								(endpointId = _a.endpointId),
								(_b = _a.endpointInfo),
								(endpointInfo = _b === void 0 ? {} : _b),
								(region = _a.region);
							_f.label = 2;
						case 2:
							_f.trys.push([2, 4, , 5]);
							(_c = userInfo !== null && userInfo !== void 0 ? userInfo : {}),
								(address = _c.address),
								(attributes = _c.attributes),
								(demographic = _c.demographic),
								(location_1 = _c.location),
								(metrics = _c.metrics),
								(optOut = _c.optOut);
							(_d = this.clientInfo),
								(appVersion = _d.appVersion),
								(make = _d.make),
								(model = _d.model),
							...
							input = {
								...
								EndpointRequest: {
									...
									Attributes: tslib_1.__assign(
										tslib_1.__assign({}, endpointInfo.attributes),
										attributes
									),
									Demographic: tslib_1.__assign(
										{
										...
										core_1.transferKeyToUpperCase(
											tslib_1.__assign(
												tslib_1.__assign({}, endpointInfo.demographic),
												demographic
											)
										)
									),
									Location: core_1.transferKeyToUpperCase(
										tslib_1.__assign(
											tslib_1.__assign({}, endpointInfo.location),
											location_1
										)
									),
									Metrics: tslib_1.__assign(
										tslib_1.__assign({}, endpointInfo.metrics),
										metrics
									),
									OptOut:
										optOut !== null && optOut !== void 0
											? optOut
											: endpointInfo.optOut,
									User: {
										UserId:
											(_e =
												userId !== null && userId !== void 0
													? userId
													: endpointInfo.userId) !== null && _e !== void 0
												? _e
												: credentials.identityId,
										UserAttributes:
											attributes !== null && attributes !== void 0
												? attributes
												: endpointInfo.userAttributes,
									},
								},
							};
		...
		this.clientInfo =
			(_a = core_1.ClientDevice.clientInfo()) !== null && _a !== void 0
				? _a
				: {};
		this.logger = logger;
	}
