	...
	function AWSPinpointProvider() {
		...
		_this.configure = function (config) {
			...
			_this.config = __assign(
				__assign({}, _super.prototype.configure.call(_this, config)),
			...
			if (!_this.configured) {
				...
				var launchNotificationOpenedListener_1 = addEventListener(
			...
			return __awaiter(_this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						...
						case 2:
							_a.trys.push([2, 4, , 5]);
							this.config.endpointInfo = __assign(
								__assign({}, this.config.endpointInfo),
								{ address: address }
							);
