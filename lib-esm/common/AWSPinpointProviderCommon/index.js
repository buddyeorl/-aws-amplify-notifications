...
var AWSPinpointProviderCommon = /** @class */ (function () {
	function AWSPinpointProviderCommon(logger) {
						...
						case 2:
							...
							input = {
								...
								EndpointRequest: {
									...
									Attributes: __assign(
										__assign({}, endpointInfo.attributes),
										attributes
									),
									Demographic: __assign(
										...
										transferKeyToUpperCase(
											__assign(
												__assign({}, endpointInfo.demographic),
												demographic
											)
										)
									),
									Location: transferKeyToUpperCase(
										__assign(__assign({}, endpointInfo.location), location_1)
									),
									Metrics: __assign(
										__assign({}, endpointInfo.metrics),
										metrics
									),
									OptOut:
		...
		this.clientInfo =
			(_a = ClientDevice.clientInfo()) !== null && _a !== void 0 ? _a : {};
		this.logger = logger;
	}
	/**
