	...
	var EventType = (
		(_c =
			Schedule === null || Schedule === void 0
				? void 0
				: Schedule.EventFilter) === null || _c === void 0
			? void 0
			: _c.Dimensions
	).EventType;
	var memoKey = CampaignId + ':' + eventType;
	if (!eventNameMemo.hasOwnProperty(memoKey)) {
		eventNameMemo[memoKey] = !!(EventType === null || EventType === void 0
			? void 0
			: EventType.Values.includes(eventType));
	}
...
exports.matchesAttributes = function (_a, _b) {
	...
	if (!eventAttributesMemo.hasOwnProperty(memoKey)) {
		eventAttributesMemo[memoKey] = Object.entries(Attributes).every(function (
			_a
		) {
...
exports.isQuietTime = function (message) {
	...
	if (
		!(Schedule === null || Schedule === void 0 ? void 0 : Schedule.QuietTime)
	) {
		return false;
	}
	...
	var _b = tslib_1.__read(Start.split(':'), 2),
		startHours = _b[0],
		startMinutes = _b[1];
	var _c = tslib_1.__read(End.split(':'), 2),
		endHours = _c[0],
		endMinutes = _c[1];
	start.setHours(
...
exports.extractContent = function (_a) {
	var message = _a.InAppMessage,
		_b = _a.platform,
		platform = _b === void 0 ? 'Web' : _b;
	var _c, _d;
	return (_d =
		(_c = message === null || message === void 0 ? void 0 : message.Content) ===
			null || _c === void 0
			? void 0
			: _c.map(function (content) {
					...
					// Determine the button configuration based on the platform or use default
					var getButtonConfig = function (button, defaultConfig) {
						return platform && button && button[platform]
							? tslib_1.__assign(
					...
					var defaultPrimaryButton = getButtonConfig(
						PrimaryBtn,
						PrimaryBtn === null || PrimaryBtn === void 0
							? void 0
							: PrimaryBtn.DefaultConfig
					);
					var defaultSecondaryButton = getButtonConfig(
						SecondaryBtn,
						SecondaryBtn === null || SecondaryBtn === void 0
							? void 0
...
exports.extractMetadata = function (_a) {
	...
	return {
		customData:
			InAppMessage === null || InAppMessage === void 0
				? void 0
				: InAppMessage.CustomConfig,
		endDate:
			Schedule === null || Schedule === void 0 ? void 0 : Schedule.EndDate,
		priority: Priority,
